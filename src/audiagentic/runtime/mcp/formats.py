"""Canonical mcp-json format handlers for MCP server config files.

Format: {"mcpServers": {"name": {"command": ..., "args": [...], "env": {...}}}}

Used by providers that follow the standard MCP server config convention.
Preserves unknown top-level keys (e.g. settings blocks) on write.
"""
