...
from audiagentic.runtime.rig.errors import make_rig_launch_error_ext
...
def start_embedded_rig(
    *,
    ...
    raise make_rig_launch_error_ext(1, last_error or f"Unable to launch rig on {host}", host=host, port=port)
