...
class TaskMgr(BaseMgr):
    def create(self, id_: str, label: str, summary: str, spec_ref: str, domain: str = 'core', state: str = 'draft', parent_task_ref: str | None = None, target: str | None = None, workflow: str | None = None):
