...
class CopilotEventExtractor(BaseEventExtractor):
    """Parse Copilot plain-text output into canonical provider-stream-event records."""

    extractor_name = "copilot-plaintext"
