...
def install_release_please(
    ...
    return release_api.install(_project_root(), release_type, branch, python_version, initial_version)
...
def update_release_please_workflow(branch: str = "main", python_version: str = "3.13") -> dict:
    ...
    return release_api.update_workflow(_project_root(), branch, python_version)
...
def finalize_release(release_id: str = "rel_0001") -> dict:
    ...
    return release_api.finalize(_project_root(), release_id)
