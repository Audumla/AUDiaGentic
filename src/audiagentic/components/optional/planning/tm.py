...
Usage (from any directory):
    python -m audiagentic.components.optional.planning.tm --root <project-root> validate
    python -m audiagentic.components.optional.planning.tm validate  # defaults to project root detection
"""
...
def _find_project_root() -> Path:
    ...
    for p in [cwd, *cwd.parents]:
        if (p / ".audiagentic" / "planning").exists():
            return p
    # Fallback: src/audiagentic/components/optional/planning/../../../../../
...
def main():
    ...
    p_new.add_argument(
        "--profile",
        default=None,
        help="Profile name for request defaults and stack topology.",
    )
    p_new.add_argument(
        "--guidance",
