...
#projects.layout-columns { display:grid; grid-template-columns:repeat(auto-fit,minmax(min(100%,460px),1fr)); gap:14px; align-items:start } #projects.layout-columns .project { margin:0; min-width:0 } #projects.layout-rows { display:block } .work-section { margin-top:12px } .work-section > h3 { color:var(--muted); font-size:11px; letter-spacing:.1em; text-transform:uppercase; margin:0 0 7px } .request-grid { display:grid; gap:6px } .request-row { display:grid; grid-template-columns:minmax(150px,1.3fr) minmax(105px,.8fr) minmax(125px,1fr) minmax(125px,1fr) minmax(140px,1.4fr); gap:8px; align-items:start; padding:8px 9px; border:1px solid #263757; border-radius:8px; background:#101a30 } .request-row > div { min-width:0; overflow-wrap:anywhere } .request-row .request-identity { display:flex; gap:5px; align-items:center; flex-wrap:nowrap; min-width:0 } .request-row .request-id { min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap } .request-row .request-meta { color:var(--muted); font-size:12px } .request-row .request-error { color:var(--red); font-size:12px } .request-row .request-label { color:var(--muted); font-size:10px; text-transform:uppercase; letter-spacing:.06em; display:block } .session-actions { display:flex; gap:5px; align-items:center; justify-content:flex-end } .icon-button { min-width:30px !important; width:30px; height:28px; flex:0 0 30px; padding:4px !important; font-size:16px !important } .icon-button svg { width:15px; height:15px; fill:none; stroke:currentColor; stroke-width:1.8; stroke-linecap:round; stroke-linejoin:round } .icon-button.feedback { border-color:var(--teal); color:var(--teal) }
