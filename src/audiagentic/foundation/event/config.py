"""Configuration for the foundation event layer."""
...
def load_config(root: Path | None = None) -> EventConfig:
    ...
    Returns:
        EventConfig: Loaded configuration
    """
    if root is None:
        root = _find_root()
        ...
        try:
            ...
            return EventConfig(
                ...
                event_store=EventStoreConfig(
                    ...
                    .get("event_store", {})
                    .get("path", "runtime/foundation/events"),
