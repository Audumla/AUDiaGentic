...
GLOSSARY = {
    ...
    "tracked-docs": "git-managed files under docs/ and the managed install baseline such as selected .audiagentic config/templates and provider instruction assets",
