...
_ADAPTER_MODULES: dict[str, str] = {
    "codex": "audiagentic.providers.adapters.codex",
    "claude": "audiagentic.providers.adapters.claude",
    "gemini": "audiagentic.providers.adapters.gemini",
    "copilot": "audiagentic.providers.adapters.copilot",
    "continue": "audiagentic.providers.adapters.continue_",
    "cline": "audiagentic.providers.adapters.cline",
    "local-openai": "audiagentic.providers.adapters.local_openai",
    "qwen": "audiagentic.providers.adapters.qwen",
}
