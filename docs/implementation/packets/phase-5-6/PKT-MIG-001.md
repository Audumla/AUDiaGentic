# PKT-MIG-001 — Migration examples and heuristics fixtures
...
Add concrete migration fixtures and assertions for each migration outcome class.
...
- `docs/examples/fixtures/migration/**`
- `tests/integration/lifecycle/test_migration_examples.py`
...
```python
def assert_migration_examples():
    for fixture in load_migration_fixtures():
        outcome = classify_doc(fixture.source, fixture.target)
        assert outcome == fixture.expected_outcome
```
...
- migration outcome fixtures

## Tests to add

- all documented migration outcomes have concrete examples
