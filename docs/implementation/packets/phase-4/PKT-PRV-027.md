...
Document and isolate the provider-specific execution model for Continue, without changing the shared canonical tag grammar.
...
3. Update only the provider-specific execution notes, settings profile, and smoke-test guidance for Continue.
...
- the provider-specific execution doc is isolated to Continue
...
Continue CLI / IDE prompt files; mapped execution through invokable prompt assets
