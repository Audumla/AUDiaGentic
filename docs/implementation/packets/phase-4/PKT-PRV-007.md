...
- `src/audiagentic/providers/adapters/copilot.py`
- `tests/integration/providers/test_copilot.py`
...
```python
def run_copilot(packet_ctx, provider_cfg):
    req = build_provider_request(packet_ctx)
    resp = call_copilot(req, provider_cfg)
