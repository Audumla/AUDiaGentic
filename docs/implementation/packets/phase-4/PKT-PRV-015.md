# PKT-PRV-015 — codex prompt-tag surface integration
...
Implement the codex CLI / VS Code prompt-tag rollout.
...
- `docs/implementation/providers/03_Codex_Plan.md`
...
codex settings-profile, wrapper/extension entry points, and smoke tests
