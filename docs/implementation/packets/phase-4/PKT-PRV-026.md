# PKT-PRV-026 — GitHub Copilot tag execution implementation
...
Document and isolate the provider-specific execution model for GitHub Copilot, without changing the shared canonical tag grammar.
...
3. Update only the provider-specific execution notes, settings profile, and smoke-test guidance for GitHub Copilot.
...
- the provider-specific execution doc is isolated to GitHub Copilot
...
Copilot CLI / VS Code agent mode; mapped execution through a thin adapter
