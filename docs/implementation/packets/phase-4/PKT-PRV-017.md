...
Implement the gemini CLI / VS Code prompt-tag rollout.
...
- `docs/implementation/providers/04_Gemini_Plan.md`
...
gemini settings-profile, wrapper/extension entry points, and smoke tests
