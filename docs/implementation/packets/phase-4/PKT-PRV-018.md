...
Implement the copilot prompt-tag rollout with VS Code-first path and optional CLI bridge.
...
- `docs/implementation/providers/05_Copilot_Plan.md`
...
copilot settings-profile, extension path, optional bridge wrapper, and smoke tests
