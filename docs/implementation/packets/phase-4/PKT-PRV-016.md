# PKT-PRV-016 — claude prompt-tag surface integration
...
Implement the claude CLI / VS Code prompt-tag rollout.
...
- `docs/implementation/providers/02_Claude_Plan.md`
...
claude settings-profile, wrapper/extension entry points, and smoke tests
