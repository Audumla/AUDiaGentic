...
Implement the continue CLI / VS Code prompt-tag rollout.
...
- `docs/implementation/providers/06_Continue_Plan.md`
...
continue settings-profile, wrapper/extension entry points, and smoke tests
