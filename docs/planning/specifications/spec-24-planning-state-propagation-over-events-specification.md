...
# Notes
Completion update on 2026-04-19: propagation rules, planning event subscription, propagation logging, invalid-transition guard, knowledge reaction path, and audit/repair tooling are implemented. Request-18 scope is complete; any later naming/ref cleanup belongs under request-31.
