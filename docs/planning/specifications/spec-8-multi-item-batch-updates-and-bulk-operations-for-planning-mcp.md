...
```json
{
  ...
  "items_count": 3,
  "results": [
    {"id": "task-0200", "operations_executed": 2, "results": [...]},
    {"id": "task-0201", "operations_executed": 1, "results": [...]},
    {"id": "task-0202", "operations_executed": 1, "results": [...]}
  ],
  "errors": []
}
```
...
```json
{
  ...
  "succeeded": 6,
  "failed": 0,
  "transitioned_ids": ["task-0200", "task-0201", ...],
  "errors": []
}
```
...
**After:** `tm_bulk_state(ids=["task-0200"...], new_state="done", summary_only=True)`
- 1 call
