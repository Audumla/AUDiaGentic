...
- task-0183: Verify real relation schema contract and remove stale meta.task_refs assumption
- task-0184: Automatic counter sync after hard deletions
- task-0185: Soft delete functionality (tm_delete)
- task-0186: Auto-reference updates for plans and tasks
- task-0187: Duplicate detection for requests and specs
- task-0188: Improved schema validation error messages
- task-0189: Integration tests for all critical fixes

# Inputs

- spec-002 (implementation specification)
- plan-005 (execution plan)
