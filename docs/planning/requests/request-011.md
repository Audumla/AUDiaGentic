...
This is a refinement of `request-008` with clearer naming. "Guidance level" describes what it actually controls (how much guidance/detail is required in planning records), whereas "audience profile" was ambiguous about whether it described the writer or reader.
...
Supersedes `request-008` (audience-level profiles) with clearer terminology.
