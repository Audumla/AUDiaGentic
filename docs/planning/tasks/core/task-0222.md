...
Depends on task-0221 (lookup.json must exist before these helpers can be used). These helpers are internal — not part of the public tm_helper or MCP surface yet (that is task-0225).
