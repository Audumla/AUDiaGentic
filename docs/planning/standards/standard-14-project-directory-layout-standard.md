...
state: ready
summary: Default directory structure and file organization for AUDiaGentic-based Python projects, covering source trees, configuration, tests, tools, and documentation layouts.
---
