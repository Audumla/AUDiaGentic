...
state: done
summary: Execute a focused planning-core hardening slice covering relation-schema verification,
  soft delete, hard-delete counter safety, traceability, duplicate prevention,
...
**Phase 1: Relation-Schema Verification (task-0195)**
...
**Phase 6: Validation Feedback (task-0200)**
...
**Phase 7: Integration Coverage (task-0201)**
...
- wp-0010 (critical fixes work package)
