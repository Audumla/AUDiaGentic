...
## Phase 1: Core State Machine (task-0022)
- Add `archived` state to state machine
- Define valid state transitions
- Update state validation logic

## Phase 2: Archive Functions (task-0023)
...
## Phase 3: Query Filtering (task-0024)
