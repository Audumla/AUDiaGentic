...
1. `task-0170` documentation surfaces
2. `task-0182` profile packs and request profiles
3. `task-0171` reference docs
4. `task-0172` manifest and migration scaffolding boundaries
5. `task-0173` helper and MCP expansion
6. `task-0174` section registry and subsection limits
7. `task-0175` supporting-doc metadata and sidecar behavior
8. `task-0176` documentation-sync obligations and verification coverage
...
- `wp-002` covers `task-0170` to `task-0172`
- `wp-003` covers `task-0173` and `task-0174`
- `wp-004` covers `task-0175` and `task-0176`
