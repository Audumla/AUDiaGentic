...
Document and isolate the provider-specific execution model for Cline, without changing the shared canonical tag grammar.
...
3. Update only the provider-specific execution notes, settings profile, and smoke-test guidance for Cline.
...
- the provider-specific execution doc is isolated to Cline
...
Cline editor / CLI hook path; native intercept with workflow aliases
