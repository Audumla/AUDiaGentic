...
## Purpose
Implement the `copilot` adapter on top of the frozen provider contract from Phase 4.

## Packet mapping
- primary packet: `PKT-PRV-007`
- dependency packets: `PKT-PRV-001`, `PKT-PRV-002`

## Required capabilities
- load provider config using canonical provider id `copilot`
