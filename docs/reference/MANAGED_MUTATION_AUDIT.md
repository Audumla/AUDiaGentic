...
| src/audiagentic/components/providers/adapters/opencode/plugin_array.py:write_opencode_plugin | atomic_write_json | adapter-serializer | atomic foundation writer | keep | Migrated to atomic_write_json, consolidated load helper (MA04 follow-on, 2026-07-14). |
