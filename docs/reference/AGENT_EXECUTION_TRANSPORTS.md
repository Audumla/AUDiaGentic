...
## Current proof and remaining integration
...
transport and thin OpenCode launch binding exist. Agents-gateway event forwarding,
cancellation, bounded retention/backpressure, redaction verification, malformed
frame fixtures, and Docker packaging smoke remain before MA18 completion.
