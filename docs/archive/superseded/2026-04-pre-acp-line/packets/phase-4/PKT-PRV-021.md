...
Implement the bridge-owned prompt-tag rollout for OpenAI-compatible and qwen-backed surfaces.
...
- `docs/implementation/providers/01_Local_OpenAI_Compatible_Plan.md`
- `docs/implementation/providers/08_Qwen_Plan.md`
...
bridge-wrapper settings-profile, wrapper entry points, and smoke tests for local-openai/qwen
