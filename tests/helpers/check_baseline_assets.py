...
def _build_managed_header_paths() -> list[str]:
    """Managed header check applies only to skill surface files generated by renderer."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Verify that managed markdown surfaces carry AUDiaGentic managed header.",
    )
