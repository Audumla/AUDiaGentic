...
- `docs/installer/regression-matrix.md` (output from task-0261)
...
- `docs/installer/validation-categories.md` (output from task-0256)
- `docs/installer/resolution-reconcile-contract.md` (output from task-0255)
- `docs/installer/cli-command-contract.md` (output from task-0254)
...
- `wp-0020` — architecture and boundaries scope
- `wp-0021` — CLI and reconcile scope
- `wp-0022` — targets, backends, and artifacts scope
- `wp-0023` — verification and packetization scope
- `spec-0053` — packetization spec
...
- Which WP it maps to (WP-0020, WP-0021, WP-0022, or WP-0023)
